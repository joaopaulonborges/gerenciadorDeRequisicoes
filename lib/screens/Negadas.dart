...
class Negadas extends StatefulWidget {

  String _idCliente, _tipoRequisicao;
  RequisicaoBloc _lista;

  Negadas(this._idCliente, this._tipoRequisicao, this._lista);

  @override
  _NegadasState createState() => _NegadasState();
}

class _NegadasState extends State<Negadas> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    reference.snapshots().listen((querySnapshot) {
      querySnapshot.documentChanges.forEach((change) {
        setState(() {
          widget._lista.negadas = recuperarRequsicoes(widget._idCliente, widget._tipoRequisicao);
        });
      });
    });
  }
