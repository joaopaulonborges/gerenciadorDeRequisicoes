...
import 'package:gerenciador_de_requisicao/screens/RequisicaoPendente.dart';
...
class Pendentes extends StatefulWidget {
  ...
  Pendentes(this._idCliente, this._tipoRequisicao, this._lista);

  @override
  _PendentesState createState() => _PendentesState();
}

class _PendentesState extends State<Pendentes> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    reference.snapshots().listen((querySnapshot) {
      querySnapshot.documentChanges.forEach((change) {
        setState(() {
          widget._lista.pendentes = recuperarRequsicoes(widget._idCliente, widget._tipoRequisicao);
        });
      });
    });
  }
  ...
  Widget build(BuildContext context) {
    return Column(
      children: <Widget>[
        Expanded(
          child: FutureBuilder(
            future: widget._lista.pendentes,
