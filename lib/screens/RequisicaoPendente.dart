...
class RequisicaoPendente extends StatefulWidget {
  ...
  RequisicaoPendente(this._idRequisicao, this._descricaoRequisicao, this._rca, this._razaosocial, this._pedido, this._valor, this._tipoRestricao, this._item, this._data, this._limite, this._idUsuario, this._hora);

  @override
  _RequisicaoPendenteState createState() => _RequisicaoPendenteState();
}

class _RequisicaoPendenteState extends State<RequisicaoPendente> with SingleTickerProviderStateMixin {
                    ...
                    children: <Widget>[
                      Align(
                        ...
                        child: Padding(
                          ...
                          child: Text(
                            "Autoriza envio de pedido para o cliente que está com restrição de venda?",
                            style: TextStyle(
                              fontSize: 20,
                        ...
                        children: <Widget>[
                          ...
                          Align(
                            ...
                            child: Padding(
                              padding: EdgeInsets.fromLTRB(32, 8, 32, 8),
                              child: Text(
                                widget._valor!="" ? "R\$ "+widget._valor : "R\$ 0",
                                style: TextStyle(
                                  fontSize: 14,
                                ),
                              ),
                    ...
                    children: <Widget>[
                      Align(
                        ...
                        child: Padding(
                          padding: EdgeInsets.fromLTRB(32, 16, 32, 8),
                          child: Text(
                            "Autoriza envio de pedido para o cliente que está com limite de crédito atingido?",
                            style: TextStyle(
                              fontSize: 20,
                              fontWeight: FontWeight.bold,
                            ),
                    ...
                    children: <Widget>[
                      Align(
                        ...
                        child: Padding(
                          padding: EdgeInsets.fromLTRB(32, 16, 32, 8),
                          child: Text(
                            "Autoriza envio de pedido com preço abaixo do permitido?",
                            style: TextStyle(
                              fontSize: 20,
                              fontWeight: FontWeight.bold,
                            ),
  ...
  aceitarRequisicao() async{
    Firestore db = Firestore.instance;
    db.collection("requisicoes").document(widget._idUsuario).collection("aceitas").document(widget._idRequisicao).
    setData(
      {
        "id" : widget._idRequisicao,
        "descricao" : widget._descricaoRequisicao,
        "pedido" : widget._pedido,
        "razaosocial" : widget._razaosocial,
        "rca" : widget._rca,
        "tiporestricao" : widget._tipoRestricao,
        "valor" : widget._valor,
        "item" : widget._item,
        "data" : widget._data,
        "hora" : widget._hora,
        "limite" : widget._limite,
      }
    );
    db.collection("requisicoes").document(widget._idUsuario).collection("pendentes").document(widget._idRequisicao).delete();
  }

  negarRequisicao() async{
    Firestore db = Firestore.instance;
    db.collection("requisicoes").document(widget._idUsuario).collection("negadas").document(widget._idRequisicao).
    setData(
        {
          "id" : widget._idRequisicao,
          "descricao" : widget._descricaoRequisicao,
